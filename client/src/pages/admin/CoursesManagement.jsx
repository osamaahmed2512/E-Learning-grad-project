  ...
  return (
    <div className="min-h-screen p-2 sm:p-4 md:p-6 lg:p-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
        <div className="flex items-center border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-blue-500 bg-white w-full">
            ...
            <div className="flex flex-col md:flex-row gap-4 p-4 sm:p-6">
              ...
              <div className="md:w-1/2 w-full flex flex-col gap-4">
                ...
                {selectedCourse.img_url && (
                  <div className="w-full h-40 sm:h-48 md:h-56 bg-gray-100 rounded-xl flex items-center justify-center overflow-hidden">
                    <img
              ...
              <div className="md:w-1/2 w-full flex flex-col gap-4">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 bg-gray-50 rounded-lg p-4">
                  ...
                  <div className="bg-white p-2 sm:p-3 rounded-lg shadow-sm min-w-0">
                    ...
                    <span className="font-semibold text-gray-800 text-sm sm:text-base break-words">{Number(selectedCourse.no_of_hours).toFixed(2)}</span>
                  </div>
                  <div className="bg-white p-2 sm:p-3 rounded-lg shadow-sm min-w-0">
                              ...
                              {section.lessons.map(lesson => (
                                <li key={lesson.id} className="text-gray-700 text-xs sm:text-sm flex items-center gap-2">
                                  ...
                                  {lesson.duration_in_hours && (
                                    <span className="text-xs text-gray-500">({lesson.duration_in_hours}h)</span>
                                  )}
                                </li>
                              ))}
                            </ul>
