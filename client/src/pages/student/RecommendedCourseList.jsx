  ...
  useEffect(() => {
    const fetchRecommendations = async () => {
      try {
        ...
        const response = await axios.get(`${BASE_URL}/api/Recommendations`, { headers, timeout: 20000 });
        ...
        setError('Oops! Something went wrong while loading recommended courses. Please check your connection or try again in a few moments.');
        setIsLoading(false);
      }
    };
        ...
        {error && (
          <div className="col-span-full py-12 px-4">
            <div className="max-w-md mx-auto bg-gradient-to-r from-red-100 to-yellow-100 p-6 rounded-lg shadow-md flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold text-red-700 mb-2">Whoops! Trouble Fetching Recommendations</h3>
