    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full'>
      <div className='flex flex-col md:flex-row items-start px-8 md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <p className='mt-6 text-center md:text-left text-sm text-white/80'>Empower your teaching journey with our educator platform. Create engaging courses, track student progress, and make a lasting impact on learners worldwide.</p>
        </div>
        <div className='flex flex-col md:items-start items-center w-full'>
          ...
          <div className='flex items-center gap-2 pt-4'>
            ...
            <button className='bg-blue-600 w-24 h-9 text-white rounded hover:bg-sky-700 cursor-pointer'>Subscribe</button>
          </div>
          </div>
      </div>
